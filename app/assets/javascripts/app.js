...
var App = function () {
  ...
  var handleFixedSidebar = function () {
    ...
    // for fixed with closed sidebar effect
    //if ($('.page-sidebar-fixed').size() === 0) {
    if ($('.page-sidebar-fixed').size() === 0 || $('.page-sidebar-closed').size() > 0) {
      handleSidebarAndContentHeight();
      return;
    }
  ...
  var handleFixedSidebarHoverable = function () {
    ...
    $('.page-sidebar').off('mouseenter').on('mouseenter', function () {
      ...
      {
        body.addClass('page-sidebar-hover-on');
        return;
      }
    ...
    if (jQuery().select2) {
      $('.select2me').select2({
        ...
        matcher: function(term, text) {
            ...
            tf1 = text.toUpperCase().indexOf(term.toUpperCase())==0;
            tf2 = mod.join("").toUpperCase().indexOf(term.toUpperCase())==0;  
            return (tf1||tf2);  
        }
      });
    }
